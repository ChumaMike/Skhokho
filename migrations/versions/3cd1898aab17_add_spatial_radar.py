...
Revision ID: 3cd1898aab17
Revises: cc4a063059d1
Create Date: 2026-02-05 16:19:12.712906
...
revision = '3cd1898aab17'
down_revision = 'cc4a063059d1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('location_tag', schema=None) as batch_op:
        batch_op.create_index('idx_location_tag_coordinates', ['coordinates'], unique=False, postgresql_using='gist')
...
def downgrade():
    ...
    with op.batch_alter_table('location_tag', schema=None) as batch_op:
        batch_op.drop_index('idx_location_tag_coordinates', postgresql_using='gist')
